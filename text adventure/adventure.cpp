...
int main()
{
    ...
    std::cout << " je kijk rond en je ziet een speer liggen" << '\n';
    ...
    if (keuze == 2)
    {
        std::cout << "je vind een kastje met blikje eten" << '\n';
        std::cout << "je eet het blikje is al 3 jaar over de datum" << '\n';
        ...
        if (keuze3 == 1)
        {
            ...
            std::cout << "je wordt wakker bij een cannibalen rituel en je wordt levend opgegeten" << '\n';
        }
        else if (keuze3 == 2)
        {
    ...
    if (keuze == 1)
    {
        ...
        std::cout << "2. je gaat met een tijger zoeken om mee te vechten omdat je toch niks anders kunt doen" << '\n';
        ...
        {
            std::cout << "je vecht met de tijger en maar hij is te sterk en je gaat dood" << '\n';
        }
        else
        {
            std::cout << "Ongeldige keuze. Je gaat dood " << '\n';
    ...
    {
        std::cout << "de mensen kijken je heel erg aan" << '\n';
        std::cout << "je wordt bang" << '\n';
        ...
        {
            std::cout << "de mensen komen allemaal naar je toen" << '\n';
